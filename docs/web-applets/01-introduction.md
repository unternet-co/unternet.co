---
layout: docs
title: Introduction - Web Applets
permalink: /docs/web-applets/introduction/
tags: docs
eleventyNavigation:
  key: Introduction
  parent: Web Applets
...
<figure>
<img src="/docs/web-applets/assets/maps-demo.gif" alt="A user interface showing a client loading up a graphical map applet in response to a query" />
